...
FILESEXTRAPATHS:prepend:versal-vrk165-sdt-seg:imgrcvry := "${THISDIR}/files:"
FILESEXTRAPATHS:prepend:versal-vrk165-sdt-seg:linux := "${THISDIR}/files:"
...
EXTRA_DT_INCLUDE_FILES:append:versal-vrk165-sdt-seg:imgrcvry = " imgrcvry-system-conf.dtsi"
EXTRA_DT_INCLUDE_FILES:append:versal-vrk165-sdt-seg:linux    = " imgrcvry-system-conf.dtsi"
